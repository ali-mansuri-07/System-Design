package com.interviewQuestions.bookmyshow;

import com.interviewQuestions.bookmyshow.controllers.BookingController;
import com.interviewQuestions.bookmyshow.controllers.TheatreController;
...
import com.interviewQuestions.bookmyshow.entities.Seat;
...
public class BookMyShowApp {
    ...
    private void userFlow() {
        ...
        // User enters system
        User user = new User("U1", "Ali");

        System.out.println("User logged in: Ali");
        ...
        List<Movie> movies = theatreController.getMovies(selectedCity, selectedDate);
        ...
        List<Theatre> theatres = theatreController.getTheatres(selectedCity, selectedMovie.getMovieName(),
                selectedDate);
