...
public class WordProcessorSimulation {
    public static void main(String[] args) {
        ...
        // Create 11 character objects and provide display position(extrinsic state) at
        // runtime
        ...
        // Total characters created: 8 - because we are reusing the same obj
        System.out.println("Total characters created: " + new LetterFactory().getTotalLetters());
    }
}
