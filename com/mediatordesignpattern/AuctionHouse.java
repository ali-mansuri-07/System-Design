...
public class AuctionHouse implements AuctionMediator {
    ...
    public AuctionHouse(String itemName, double startingPrice) {
        ...
        System.out
                .println("[+] Auction House created for item: " + itemName + " with initial bid of $" + startingPrice);
    }
    ...
    public void placeBid(IColleague bidder, double bidAmount) {
        ...
        if (bidAmount <= currentHighestBid) {
            System.out.println(bidder.getName() + " bid of $" + bidAmount + " is too low. Current highest bid is $"
                    + currentHighestBid);
        ...
        System.out.println("\n===> [New Bid Accepted]" + " Info: {Bidder: " + bidder.getName() + ", Bid Amount: "
                + bidAmount + "}");
